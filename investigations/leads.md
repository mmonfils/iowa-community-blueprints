...
## I. CRITERIA FOR CHOOSING A TOPIC
...
### Phase 2: The Verification Gate (Fact-Checking)
*Objective: Cross-referencing raw ideas with public records to ensure we are building on a true premise. In compliance with Section I of our Stress Test, an idea cannot move forward until it is explicitly linked to a verified public record.*

| Lead ID | Systemic Concept | Verified Public Document Reference (Live URL) | Status |
| :--- | :--- | :--- | :--- |
| **L-1** | SF 2472 Service Impact | [Des Moines FY2026/27 City Manager Budget Reports] | In Progress |
| **L-2** | HF 385 Discharge Gaps | [LSA Official Fiscal Note for HF 385](https://www.legis.iowa.gov/docs/publications/FN/1524768.pdf) | Verified |

---

### Phase 3: Active Investigations
*Objective: Verified topics fully structured into strategic briefs and action roadmaps to help support community advocacy and relationship building.*

* **Active Case Study: Responsible Psychiatric Discharge Coordination (HF 385)**
  * *Tracking ID:* L-2
